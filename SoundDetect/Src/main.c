...
void timer2_cb(void const * argument);
...
int main(void)
{
  ...
  htim3.Instance->CR1 &= 0<<0;//Disable count function
	htim3.Instance->CNT = 0; //Clear count number
	
	HAL_TIM_Base_Start_IT(&htim8);
	HAL_ADC_Start_DMA(&hadc1, (uint32_t*)&adc_buffer, SAMPLE_NUM*3); //
	
  /* USER CODE END RTOS_TIMERS */

  /* Create the queue(s) */
  /* definition and creation of coreQueue */
  osMessageQDef(coreQueue, 16, uint8_t);
...
/* timer2_cb function */
__weak void timer2_cb(void const * argument)
{
  /* USER CODE BEGIN timer2_cb */
  
  /* USER CODE END timer2_cb */
}
